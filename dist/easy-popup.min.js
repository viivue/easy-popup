 ...
 * @license MIT 2022
 */
var p={d:(t,e)=>{for(var o in e)p.o(e,o)&&!p.o(t,o)&&Object.defineProperty(t,o,{enumerable:!0,get:e[o]})},o:(t,e)=>Object.prototype.hasOwnProperty.call(t,e)},l={};function h(t,e=!0){const o=[...t];return e?o.sort(((t,e)=>t.breakpoint<e.breakpoint?1:-1)):o.sort(((t,e)=>t.breakpoint>e.breakpoint?1:-1)),o}function d(t,e=150){let o;return(...s)=>{clearTimeout(o),o=setTimeout((()=>{t.apply(this,s)}),e)}}p.d(l,{o:()=>u});class u{constructor(t){if(this.dev=!0===t.dev,this.object=t.object||void 0,this.object){if(this.onMatched=t.onMatched,this.onUpdate=t.onUpdate,window.addEventListener("resize",d((()=>{"function"==typeof this.onUpdate&&this.onUpdate(this.currentObject)}),this.debounce)),!this.object.responsive)return this.currentObject={type:"no-responsive",lastBreakpoint:void 0,breakpoint:-1,object:this.mergeObject(-1,this.object)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject),this.dev&&console.warn("Property object must have responsive array."),!1;this.isInherit=void 0===t.isInherit||t.isInherit,this.debounce=t.debounce||100,this.currentObject={breakpoint:void 0,object:{}},this.object.responsive=h(this.object.responsive),this.match(),window.addEventListener("resize",d((()=>this.match()),this.debounce))}else console.error("Property object:{} must be provided.")}match(){let t=!1;for(let e=0;e<this.object.responsive.length;e++){const o=this.object.responsive[e];if(t=matchMedia(this.getQuery(e)).matches,t){this.currentObject.breakpoint!==o.breakpoint&&(this.currentObject={type:"responsive",lastBreakpoint:this.currentObject.breakpoint,breakpoint:o.breakpoint,object:this.mergeObject(o.breakpoint,o.settings)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject));break}}t||-1===this.currentObject.breakpoint||(this.currentObject={type:"default",lastBreakpoint:this.currentObject.breakpoint,breakpoint:-1,object:this.mergeObject(-1,this.object)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject))}getQuery(t){let e=`screen and (max-width:${this.object.responsive[t].breakpoint}px)`;const o=this.object.responsive[t+1];return o&&(e+=` and (min-width:${o.breakpoint+1}px)`),e}mergeObject(t,e){let o={...e};if(this.isInherit&&-1!==t){const e=h(this.object.responsive,!1);for(let s=0;s<e.length;s++)e[s].breakpoint>t&&(o={...e[s].settings,...o})}return o={...this.object,...o},delete o.responsive,o}}var b=l.o;function f(t,e=!1){e?t.outer.removeAttribute(i.theme):t.outer.setAttribute(i.theme,t.options.theme)}function v(t,e){e.forEach((e=>{e.classList.contains(s.triggerEnabled)||(e.addEventListener("click",(e=>{e.preventDefault(),t.toggle()})),e.classList.add(s.triggerEnabled))}))}function m(t,e=document.createElement("div")){return t.parentNode.insertBefore(e,t),e.appendChild(t),e}class g{constructor(t,e){if(!t)return void console.warn("Init popup fail due to empty input!");if(this.root=document.querySelector(":root"),this.el=t,this.selector=i.init,this.innerHTML=this.el.innerHTML,this.isOpen=!1,this.id=function(t=""){return t+(+new Date).toString(16)+(1e8*Math.random()|0).toString(16)}("easy-popup-"),this.idType="auto-id",this.el.classList.contains(s.processed))return;this.events=new r(this,{names:["onClose","onOpen"]}),this.options=a({target:this.el,attributeName:i.init,defaultOptions:{...n,...e},numericValues:["autoShow","showingTimes"],onIsString:t=>{this.idType="attr-id",this.id=t}}),this.options.id&&(this.id=this.options.id,this.idType="attr-id"!==this.idType?"json-id":this.idType);const p=this.el.getAttribute(i.init);if(isNaN(p)||(this.id=`${p}`,this.idType="attr-id",console.warn("Popup ID should be a string, consider adding a prefix to your ID to avoid unexpected issue, your ID:",this.id)),this.cookie=this.options.cookie?new o(this):null,this.masterContainer=document.querySelector(`.${s.master}`),this.generateHTML(),!1!==this.options.autoShow){if(!this.cookie||this.cookie.isShow()){const t=!0===this.options.autoShow?1e3:this.options.autoShow;setTimeout((()=>this.open()),t)}}this.lenis=new c(this)}on(t,e){this.events.add(t,e)}generateHTML(){var t;this.el.classList.contains(s.processed)||(this.masterContainer||(this.masterContainer=document.createElement("div"),this.masterContainer.classList.add(s.master)),document.querySelector("body").appendChild(this.masterContainer),this.masterContainer.appendChild(this.el),this.inner=m(this.el),this.inner.classList.add(s.inner),this.container=m(this.inner),this.container.classList.add(s.container),this.overflow=m(this.container),this.overflow.classList.add(s.overflow),this.outer=m(this.overflow),this.outer.classList.add(s.outer),this.options.outerClass&&this.outer.classList.add(this.options.outerClass),this.outer.setAttribute(i.id,this.id),(t=this).outer.addEventListener("click",(e=>{(function(t,e){return!t.inner.contains(e.target)})(t,e)&&t.options.clickOutsideToClose&&t.close()})),function(t){t.options.keyboard&&document.addEventListener("keyup",(e=>{t.isOpen&&"Escape"===e.key&&t.close()}))}(this),function(t){t.options.theme.length&&"default"!==t.options.theme&&f(t)}(this),function(t){t.options.hasMobileLayout&&new b({object:{isMobile:!1,responsive:[{breakpoint:t.options.mobileBreakpoint,settings:{isMobile:!0}}]},debounce:100,onMatched:e=>{e.object.isMobile?(t.outer.classList.add("ep-mobile-layout"),f(t,!0)):(t.outer.classList.remove("ep-mobile-layout"),f(t))}})}(this),function(t){let e='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>';t.options.closeButtonInnerText&&(t.outer.classList.add(s.hasCustomClose),e=t.options.closeButtonInnerText);let o=`<button class="${s.closeButton}" ${i.toggle}>\n                    ${e}\n                </button>`;t.inner.insertAdjacentHTML("beforeend",o)}(this),function(t){let e=`a[href="#${t.id}"], [${i.toggle}="${t.id}"]`;t.options.triggerSelector&&t.options.triggerSelector.length&&(e+=`, ${t.options.triggerSelector}`),v(t,document.querySelectorAll(e)),v(t,t.outer.querySelectorAll(`[${i.toggle}]`))}(this),this.el.classList.add(s.processed,s.content))}open(){this.isOpen||(window.EasyPopupData.active&&EasyPopup.get(window.EasyPopupData.active).close(),window.EasyPopupData.active=this.id,this.outer.classList.add(s.open),this.isOpen=!0,this.root.classList.add(s.rootOpen),this.options.activeHtmlClass&&this.root.classList.add(this.options.activeHtmlClass),this.options.preventScroll&&(this.lenis.enabled()?(this.root.classList.add(s.preventScrollLenis),this.lenis.stop()):(this.root.classList.add(s.preventScroll),this.root.style.setProperty("--ep-scroll-bar-w",`${function(){const t=document.createElement("div");t.style.visibility="hidden",t.style.overflow="scroll",t.style.msOverflowStyle="scrollbar",document.body.appendChild(t);const e=document.createElement("div");t.appendChild(e);const o=t.offsetWidth-e.offsetWidth;return t.parentNode.removeChild(t),o}()}px`))),this.cookie?.onPopupOpen(),this.events.fire("onOpen"))}close(){this.isOpen&&(window.EasyPopupData.active="",this.outer.classList.remove(s.open),this.isOpen=!1,this.root.classList.remove(s.rootOpen),this.options.activeHtmlClass&&this.root.classList.remove(this.options.activeHtmlClass),setTimeout((()=>{window.EasyPopupData.active||this.options.preventScroll&&(this.lenis.enabled()?(this.root.classList.remove(s.preventScrollLenis),this.lenis.start()):this.root.classList.remove(s.preventScroll)),this.events.fire("onClose")}),300))}toggle(){this.isOpen?this.close():this.open()}}return window.EasyPopupData=new class{constructor(){this.active="",this.popups=[]}add(t){this.popups.push(t)}get(t){return this.popups.filter((e=>e.id===t))[0]}},window.EasyPopup={init:(t=`[${i.init}]`,e={})=>{document.querySelectorAll(t).forEach((t=>window.EasyPopupData.add(new g(t,e))))},get:t=>window.EasyPopupData.get(t)},window.EasyPopup.init(),e})()));